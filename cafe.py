...
f1.pack(side=LEFT)
f1a = Frame(f1, width=1200, height=330, bd=8, bg="Red")
f1a.pack(side=TOP)
f2a = Frame(f1, width=1200, height=320, bd=8, bg="Lightgrey")
f2a.pack(side=BOTTOM)

f1aa = Frame(f1a, width=600, height=450, bd=8, bg="Lightblue")
f1aa.pack(side=LEFT)
f1ab = Frame(f1a, width=600, height=430, bd=8, bg="Lightblue")
...
lblInfo = Label(Tops, font=('arial', 20, 'bold'), fg="brown",text="Rony's Restro", bd=10, anchor='w')
...
#==================================Order Info===========================
lblRef=Label(f1aa,font=('arial',12,'bold'),fg="blue",text="Reference No", bd=16, justify='left', bg="Lightblue")
...
ref_no=txtRef.get();
# --------------
lblVb=Label(f1aa,font=('arial',12,'bold'),fg="green",text="Veg Burger", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCb=Label(f1aa,font=('arial',12,'bold'),fg="red",text="Chicken Burger", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblVs=Label(f1aa,font=('arial',12,'bold'),fg="green",text="Veg Sandwich", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCs=Label(f1aa,font=('arial',12,'bold'),fg="red",text="Chicken Sandwich", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblVp=Label(f1aa,font=('arial',12,'bold'),fg="green",text="Veg Pizza", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCp=Label(f1aa,font=('arial',12,'bold'),fg="red",text="Chicken Pizza", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblFf=Label(f1aa,font=('arial',12,'bold'),fg="green",text="French Fries", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblSd=Label(f1aa,font=('arial',12,'bold'),fg="green",text="Soft Drinks/Beverages", bd=16, justify='left', bg="Lightblue")
...
#===================================Payment Info==========================
lbldate=Label(f1ab,font=('arial',12,'bold'),fg="blue",text="Date", bd=16, justify='left', bg="Lightblue")
...
date=txtdate.get()
# --------------
lblCvb=Label(f1ab,font=('arial',12,'bold'),fg="green",text="Price of Veg Burger", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCsd=Label(f1ab,font=('arial',12,'bold'),fg="green",text="Price of Soft Drinks/Beverages", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCvs=Label(f1ab,font=('arial',12,'bold'),fg="green",text="Price of Veg Sandwich", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCcs=Label(f1ab,font=('arial',12,'bold'),fg="red",text="Price of Chicken Sandwich", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCvp=Label(f1ab,font=('arial',12,'bold'),fg="green",text="Price of Veg Pizza", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCcp=Label(f1ab,font=('arial',12,'bold'),fg="red",text="Price of Chicken Pizza", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCcb=Label(f1ab,font=('arial',12,'bold'),fg="red",text="Price of Chicken Burger", bd=16, justify='left', bg="Lightblue")
...
# --------------
lblCff=Label(f1ab,font=('arial',12,'bold'),fg="green",text="Price of French Fries", bd=16, justify='left', bg="Lightblue")
